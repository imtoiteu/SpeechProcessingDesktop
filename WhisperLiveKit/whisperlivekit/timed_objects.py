...
class Segment(TimedText):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict: Dict[str, Any] = {
            ...
            # numeric seconds for click-to-seek (the formatted strings above stay for display)
            'start_s': round(self.start, 3) if self.start is not None else None,
            'end_s': round(self.end, 3) if self.end is not None else None,
        }
        if self.translation:
